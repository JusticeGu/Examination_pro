...
public class ShiroConfig {
    ...
    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean){
        ...
        filterChainDefinitionMap.put("/clientOne/logon", "securityFilter");
        filterChainDefinitionMap.put("/index", "securityFilter,perms[1]");
        filterChainDefinitionMap.put("/callback", "callbackFilter");
//        filerChainDefinationMap.put("/clientOne/logout", "anon");
        filterChainDefinitionMap.put("/clientOne/logout", "logout");
    ...
    public ShiroFilterFactoryBean factory(DefaultWebSecurityManager securityManager, Config config){
        ...
        //自定义拦截器
        filters.put("url", getURLPathMatchingFilter()); // 自定义过滤器设置 2，命名，需在设置过滤路径前
